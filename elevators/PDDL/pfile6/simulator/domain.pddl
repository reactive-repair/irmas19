...
(:action F1_1_P4_N8_N6
:parameters 	()
:precondition
	(and (passenger-at p4 n8))
:effect
 	(and
		 (not (passenger-at p4 n8))
		 (passenger-at p4 n6)))

(:action F1_2_P1_N5_E0
:parameters 	()
:precondition
	(and (passenger-at p1 n5))
:effect
 	(and
		 (not (passenger-at p1 n5))
		 (passenger-at p1 slow0)))
...
:parameters 	()
:precondition
	(and (lift-at slow1 n6))
:effect
 	(and (not (status-door-working slow1 n6))))

(:action F2_1_P2_N6_E1
:parameters 	()
:precondition
	(and (lift-at slow1 n6))
:effect
